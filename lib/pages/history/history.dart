...
class HistoryPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<HistoryPage> createState() => _HomePageState();
}

class _HomePageState extends ConsumerState<HistoryPage> {
  ...
  void initState() {
    ...
    _pendingRequests = fetchRequestHistory(apiHandler, userid: userId);
  }
